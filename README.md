...
- `MARKETING_INTELLIGENCE_ENABLED`
- `MARKETING_INTELLIGENCE_ROUTER_MODEL`
- `MARKETING_INTELLIGENCE_SEARCH_MODEL`
- `MARKETING_INTELLIGENCE_DEEP_MODEL`
- `TRADE_VISION_MODEL`
- `FLEXION_APP_TITLE`
...
```env
FLEXION_API_BASE_URL="https://openrouter.ai/api/v1"
OPENROUTER_API_KEY="sk-or-..."
CONVERSATION_AI_MODEL="openai/gpt-4o-mini"
OPENROUTER_FAST_MODEL="openai/gpt-4o-mini"
OPENROUTER_COMPLEX_MODEL="anthropic/claude-sonnet-4.5"
CONVERSATION_MODEL_OPTIONS="openai/gpt-4o-mini|GPT-4o Mini,anthropic/claude-sonnet-4.5|Claude Sonnet 4.5,google/gemini-2.5-flash|Gemini 2.5 Flash"
TRADE_VISION_MODEL="openai/gpt-4o-mini"
FLEXION_APP_TITLE="Marketing AI Platform"
MARKETING_INTELLIGENCE_ENABLED="true"
MARKETING_INTELLIGENCE_ROUTER_MODEL="openai/gpt-4o-mini"
MARKETING_INTELLIGENCE_SEARCH_MODEL="perplexity/sonar-pro"
MARKETING_INTELLIGENCE_DEEP_MODEL="perplexity/sonar-deep-research"
```
